...
import { FACTORY_ADDRESSES, INIT_CODES_HASH } from "../config/addresses";
import { ONE, ZERO, FIVE, _1000, _997, MINIMUM_LIQUIDITY } from "../constants";
import {
...
export const computePairAddress = ({
  ...
  return getCreate2Address(
    ...
    INIT_CODES_HASH[dexId]
  );
};
export class Pair {
  public readonly liquidityToken: Token;
  private readonly tokenAmounts: [CurrencyAmount<Token>, CurrencyAmount<Token>];
  public readonly dexId: DEXId = 0;
  public static getAddress(tokenA: Token, tokenB: Token, dexId: DEXId): string {
    return computePairAddress({ dexId, tokenA, tokenB });
  }
  ...
  public constructor(
    ...
    const dexId = parseInt(process.env.DEX_ID as string) as DEXId;
